...
//import com.madmusic4001.dungeonmapper.data.dao.impl.sql.DaoFilterSqlImpl;
...
//		DaoFilter filter = new DaoFilterSqlImpl(DaoFilter.Operator.EQUALS, WorldDaoSqlImpl.WorldsContract._ID,
//												String.valueOf(world.getId()));
//		Collection<DaoFilter> filters = new ArrayList<>(1);
//		filters.add(filter);
//        worldDao.delete(filter);
//		world.setId(-1);
